...
if (isset($_POST['admin_pass']) &&
    ...
    if (empty($admin_pass)) {
		...
		header("Location: ../register_office-edit.php?perror=$em&$data");
		exit;
        ...
        header("Location: ../register_office-edit.php?psuccess=$sm&$data");
        exit;
	}
    
  }else {
  	$em = "An error occurred";
    header("Location: ../register_office.php?error=$em&$data");
    exit;
  }
